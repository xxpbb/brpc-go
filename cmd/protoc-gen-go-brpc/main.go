...
// protoc-gen-go-brpc is a plugin for the Google protocol buffer compiler to
// generate Go code. Install it by building this program and making it
// accessible within your PATH with the name:
//
//	protoc-gen-go-brpc
//
// The 'go-brpc' suffix becomes part of the argument for the protocol compiler,
...
func main() {
	...
	flag.Parse()
	if *showVersion {
		fmt.Printf("protoc-gen-go-brpc %v\n", version)
		return
	}
